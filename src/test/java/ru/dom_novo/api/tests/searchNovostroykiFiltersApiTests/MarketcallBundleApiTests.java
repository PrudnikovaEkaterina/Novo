...
public class MarketcallBundleApiTests {
    ...
    void checkCountBuildingsFromMarketcallBundles() {
        int countBuildingsExpected = MarketcallBundleApiSteps.getCountBuildingsFromBundle();
    ...
    void checkCountDistinctBuildingsFromMarketcallBundles() {
        int countBuildingsExpected = MarketcallBundleApiSteps.getCountDistinctBuildingsFromMarketcallBundles();
    ...
    void checkTitleBundlesFromMarketcallApi() {
        List<String> titleListExpected = MarketcallBundleApiSteps.getTitleBundles();
    ...
    void checkIdBundlesFromMarketcallApi() {
        List<Integer> idListExpected = MarketcallBundleApiSteps.getIdBundles();
